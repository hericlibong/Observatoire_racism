...
Note de continuite Bloc 5 - workflow complet N196 :

- N196 a ete traitee dans le workflow incremental seance par seance :
  `CRSANR5L17S2026O1N196.xml`, date `2026-04-08` ;
- dry-run execute sur N196 : statut `available`, `already_processed=false`,
  `journal_status=not_processed`, exports prevus
  `data/interim/assemblee/contextual_reviews_incremental_n196_v2_mistral.jsonl`
  et
  `data/interim/assemblee/contextual_reviews_incremental_n196_v2_mistral_summary.json`,
  sans appel Mistral ni ecriture d'export ;
- traitement reel execute explicitement sur N196 avec provider `mistral` et
  `--confirm` ; aucune autre candidate n'a ete traitee ;
- exports V2 produits :
  `data/interim/assemblee/contextual_reviews_incremental_n196_v2_mistral.jsonl`
  et
  `data/interim/assemblee/contextual_reviews_incremental_n196_v2_mistral_summary.json` ;
- journal mis a jour dans `data/interim/assemblee/processing_journal_v2.jsonl`
  avec une entree `success` pour `CRSANR5L17S2026O1N196`, provider
  `mistral_v2`, modele `mistral-medium-latest`, 15 sorties relues, 0 fallback,
  `error=""` ;
- manifest regenere : N196 est refusee a la relance par defaut car deja
  journalisee ; N197 a N205 restent candidates ;
- N196 dispose maintenant d'une vue D3 de detail :
  `data/exports/d3/assemblee_session_heatmap_n196.html`, alimentee par
  `data/exports/d3/assemblee_session_heatmap_n196.json` et par l'export
  intermediaire `data/interim/assemblee/heatmap_session_n196_v2.json` ;
- la heatmap inter-seances `data/exports/d3/assemblee_sessions_overview.html`
  affiche desormais uniquement N191, N192, N193, N194, N195 et N196, chacune
  liee a sa vue de detail ;
- N197 a N205 restent non traitees et non visualisees dans l'overview tant
  qu'elles ne disposent pas d'une vue detaillee ;
- aucun changement de design final, de contrat V2, de provider ou de taxonomie
  n'a ete lance.

Note de continuite Bloc 5 - workflow complet N197 :

- N197 a ete traitee dans le workflow incremental seance par seance :
  `CRSANR5L17S2026O1N197.xml`, date `2026-04-09` ;
- dry-run execute sur N197 : statut `available`, `already_processed=false`,
  `journal_status=not_processed`, exports prevus
  `data/interim/assemblee/contextual_reviews_incremental_n197_v2_mistral.jsonl`
  et
  `data/interim/assemblee/contextual_reviews_incremental_n197_v2_mistral_summary.json`,
  sans appel Mistral ni ecriture d'export ;
- traitement reel execute explicitement sur N197 avec provider `mistral` et
  `--confirm` ; aucune autre candidate n'a ete traitee ;
- exports V2 produits :
  `data/interim/assemblee/contextual_reviews_incremental_n197_v2_mistral.jsonl`
  et
  `data/interim/assemblee/contextual_reviews_incremental_n197_v2_mistral_summary.json` ;
- journal mis a jour dans `data/interim/assemblee/processing_journal_v2.jsonl`
  avec une entree `success` pour `CRSANR5L17S2026O1N197`, provider
  `mistral_v2`, modele `mistral-medium-latest`, 12 sorties relues, 0 fallback,
  `error=""` ;
- manifest regenere : N197 est refusee a la relance par defaut car deja
  journalisee ; N198 a N205 restent candidates ;
- N197 dispose maintenant d'une vue D3 de detail :
  `data/exports/d3/assemblee_session_heatmap_n197.html`, alimentee par
  `data/exports/d3/assemblee_session_heatmap_n197.json` et par l'export
  intermediaire `data/interim/assemblee/heatmap_session_n197_v2.json` ;
- la heatmap inter-seances `data/exports/d3/assemblee_sessions_overview.html`
  affiche desormais uniquement N191, N192, N193, N194, N195, N196 et N197,
  chacune liee a sa vue de detail ;
- N198 a N205 restent non traitees et non visualisees dans l'overview tant
  qu'elles ne disposent pas d'une vue detaillee ;
- aucun changement de design final, de contrat V2, de provider ou de taxonomie
  n'a ete lance.
...
Note de continuite Bloc 5 - workflow complet N199 :

- N199 a ete traitee dans le workflow incremental seance par seance :
  `CRSANR5L17S2026O1N199.xml`, date `2026-04-09` ;
- dry-run execute sur N199 : statut `available`, `already_processed=false`,
  `journal_status=not_processed`, exports prevus
  `data/interim/assemblee/contextual_reviews_incremental_n199_v2_mistral.jsonl`
  et
  `data/interim/assemblee/contextual_reviews_incremental_n199_v2_mistral_summary.json`,
  sans appel Mistral ni ecriture d'export ;
- traitement reel execute explicitement sur N199 avec provider `mistral` et
  `--confirm` ; aucune autre candidate n'a ete traitee ;
- exports V2 produits :
  `data/interim/assemblee/contextual_reviews_incremental_n199_v2_mistral.jsonl`
  et
  `data/interim/assemblee/contextual_reviews_incremental_n199_v2_mistral_summary.json` ;
- journal mis a jour dans `data/interim/assemblee/processing_journal_v2.jsonl`
  avec une entree `success` pour `CRSANR5L17S2026O1N199`, provider
  `mistral_v2`, modele `mistral-medium-latest`, 3 sorties relues, 0 fallback,
  `error=""` ;
- manifest regenere : N199 est refusee a la relance par defaut car deja
  journalisee ; N200 a N205 restent candidates ;
- N199 dispose maintenant d'une vue D3 de detail :
  `data/exports/d3/assemblee_session_heatmap_n199.html`, alimentee par
  `data/exports/d3/assemblee_session_heatmap_n199.json` et par l'export
  intermediaire `data/interim/assemblee/heatmap_session_n199_v2.json` ;
- la heatmap inter-seances `data/exports/d3/assemblee_sessions_overview.html`
  affiche desormais uniquement N191, N192, N193, N194, N195, N196, N197,
  N198 et N199, chacune liee a sa vue de detail ;
- N200 a N205 restent non traitees et non visualisees dans l'overview tant
  qu'elles ne disposent pas d'une vue detaillee ;
- aucun changement de design final, de contrat V2, de provider ou de taxonomie
  n'a ete lance.

Note de continuite Bloc 5 - workflow complet N200 :

- N200 a ete traitee dans le workflow incremental seance par seance :
  `CRSANR5L17S2026O1N200.xml`, date `2026-04-10` ;
- dry-run execute sur N200 : statut `available`, `already_processed=false`,
  `journal_status=not_processed`, exports prevus
  `data/interim/assemblee/contextual_reviews_incremental_n200_v2_mistral.jsonl`
  et
  `data/interim/assemblee/contextual_reviews_incremental_n200_v2_mistral_summary.json`,
  sans appel Mistral ni ecriture d'export ;
- traitement reel execute explicitement sur N200 avec provider `mistral` et
  `--confirm` ; aucune autre candidate n'a ete traitee ;
- exports V2 produits :
  `data/interim/assemblee/contextual_reviews_incremental_n200_v2_mistral.jsonl`
  et
  `data/interim/assemblee/contextual_reviews_incremental_n200_v2_mistral_summary.json` ;
- journal mis a jour dans `data/interim/assemblee/processing_journal_v2.jsonl`
  avec une entree `success` pour `CRSANR5L17S2026O1N200`, provider
  `mistral_v2`, modele `mistral-medium-latest`, 11 sorties relues, 0 fallback,
  `error=""` ;
- manifest regenere : N200 est refusee a la relance par defaut car deja
  journalisee ; N201 a N205 restent candidates ;
- N200 dispose maintenant d'une vue D3 de detail :
  `data/exports/d3/assemblee_session_heatmap_n200.html`, alimentee par
  `data/exports/d3/assemblee_session_heatmap_n200.json` et par l'export
  intermediaire `data/interim/assemblee/heatmap_session_n200_v2.json` ;
- la heatmap inter-seances `data/exports/d3/assemblee_sessions_overview.html`
  affiche desormais uniquement N191, N192, N193, N194, N195, N196, N197,
  N198, N199 et N200, chacune liee a sa vue de detail ;
- N201 a N205 restent non traitees et non visualisees dans l'overview tant
  qu'elles ne disposent pas d'une vue detaillee ;
...
Note de continuite Bloc 5 - workflow complet N203 :

- N203 a ete traitee dans le workflow incremental seance par seance :
  `CRSANR5L17S2026O1N203.xml`, date `2026-04-14` ;
- dry-run execute sur N203 : statut `available`, `already_processed=false`,
  `journal_status=not_processed`, exports prevus
  `data/interim/assemblee/contextual_reviews_incremental_n203_v2_mistral.jsonl`
  et
  `data/interim/assemblee/contextual_reviews_incremental_n203_v2_mistral_summary.json`,
  sans appel Mistral ni ecriture d'export ;
- traitement reel execute explicitement sur N203 avec provider `mistral` et
  `--confirm` ; aucune autre candidate n'a ete traitee ;
- exports V2 produits :
  `data/interim/assemblee/contextual_reviews_incremental_n203_v2_mistral.jsonl`
  et
  `data/interim/assemblee/contextual_reviews_incremental_n203_v2_mistral_summary.json` ;
- journal mis a jour dans `data/interim/assemblee/processing_journal_v2.jsonl`
  avec une entree `success` pour `CRSANR5L17S2026O1N203`, provider
  `mistral_v2`, modele `mistral-medium-latest`, 18 sorties relues, 0 fallback,
  `error=""` ;
- manifest regenere : N203 est refusee a la relance par defaut car deja
  journalisee ; N204 et N205 restent candidates ;
- N203 dispose maintenant d'une vue D3 de detail :
  `data/exports/d3/assemblee_session_heatmap_n203.html`, alimentee par
  `data/exports/d3/assemblee_session_heatmap_n203.json` et par l'export
  intermediaire `data/interim/assemblee/heatmap_session_n203_v2.json` ;
- la heatmap inter-seances `data/exports/d3/assemblee_sessions_overview.html`
  affiche desormais uniquement N191, N192, N193, N194, N195, N196, N197,
  N198, N199, N200, N201, N202 et N203, chacune liee a sa vue de detail ;
- N204 et N205 restent non traitees et non visualisees dans l'overview tant
  qu'elles ne disposent pas d'une vue detaillee ;
- aucun changement de design final, de contrat V2, de provider, de prompt V2
  ou de taxonomie n'a ete lance.

Note de continuite Bloc 5 - workflow complet N204 :

- N204 a ete traitee dans le workflow incremental seance par seance :
  `CRSANR5L17S2026O1N204.xml`, date `2026-04-14` ;
- dry-run execute sur N204 : statut `available`, `already_processed=false`,
  `journal_status=not_processed`, exports prevus
  `data/interim/assemblee/contextual_reviews_incremental_n204_v2_mistral.jsonl`
  et
  `data/interim/assemblee/contextual_reviews_incremental_n204_v2_mistral_summary.json`,
  sans appel Mistral ni ecriture d'export ;
- traitement reel execute explicitement sur N204 avec provider `mistral` et
  `--confirm` ; aucune autre candidate n'a ete traitee ;
- exports V2 produits :
  `data/interim/assemblee/contextual_reviews_incremental_n204_v2_mistral.jsonl`
  et
  `data/interim/assemblee/contextual_reviews_incremental_n204_v2_mistral_summary.json` ;
- journal mis a jour dans `data/interim/assemblee/processing_journal_v2.jsonl`
  avec une entree `success` pour `CRSANR5L17S2026O1N204`, provider
  `mistral_v2`, modele `mistral-medium-latest`, 4 sorties relues, 0 fallback,
  `error=""` ;
- manifest regenere : N204 est refusee a la relance par defaut car deja
  journalisee ; N205 reste candidate ;
- N204 dispose maintenant d'une vue D3 de detail :
  `data/exports/d3/assemblee_session_heatmap_n204.html`, alimentee par
  `data/exports/d3/assemblee_session_heatmap_n204.json` et par l'export
  intermediaire `data/interim/assemblee/heatmap_session_n204_v2.json` ;
- la heatmap inter-seances `data/exports/d3/assemblee_sessions_overview.html`
  affiche desormais uniquement N191, N192, N193, N194, N195, N196, N197,
  N198, N199, N200, N201, N202, N203 et N204, chacune liee a sa vue de detail ;
- N205 reste non traitee et non visualisee dans l'overview tant qu'elle ne
  dispose pas d'une vue detaillee ;
- aucun changement de design final, de contrat V2, de provider, de prompt V2
  ou de taxonomie n'a ete lance.
...
- revoir la sensibilite du systeme aux formulations parlementaires implicites
  ou euphemisees liees a l'identite, l'appartenance nationale, l'enracinement,
  la transmission, la terre, le peuple ou la distinction entre "les Francais"
  et d'autres groupes ;
- ne pas transformer les partis politiques en declencheurs automatiques ;
- utiliser ces elements comme indices contextuels seulement lorsqu'ils sont
  combines a des formulations d'identite, d'appartenance, d'exclusion, de
  hierarchisation ou de ciblage de groupes ;
- ne pas modifier le prompt Mistral V2, le lexique ou le contrat pendant le
  workflow seance par seance en cours.
